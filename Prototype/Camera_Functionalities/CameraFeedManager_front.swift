...
protocol CameraFeedManagerFrontDelegate: AnyObject {
  ...
  func cameraFeedManagerFront(
    _ cameraFeedManagerFront: cameraFeedManagerFront, didOutput pixelBuffer: CVPixelBuffer)
}

/// Manage the camera pipeline.
final class cameraFeedManagerFront: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate, CameraSwitcher {

  /// Delegate to receive the frames captured by the device's camera.
  var delegate: CameraFeedManagerFrontDelegate?
  ...
  func captureOutput(
    ...
    delegate?.cameraFeedManagerFront(self, didOutput: pixelBuffer)
